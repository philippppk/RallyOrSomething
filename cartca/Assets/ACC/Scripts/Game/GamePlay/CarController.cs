...
public class CarController :MonoBehaviour, ISetColor
{
	...
	bool EnableSteerAngleMultiplier { get { return CarDriftConfig.EnableSteerAngleMultiplier; } }
	...
	public float SpeedInHour { get { return CurrentSpeed * 2; } }
	...
	void UpdateRpmAndTorqueLogic ()
	{
		...
		if (GameController.Instance && !GameController.RaceIsStarted)
		{
			if (InCutOff) return;
